...
GSEOptions = {
	...
	["UnfoundSpells"] = {
		...
		["Serenity"] = true,
		["Blackout Combo"] = true,
		["Invoke Xuen, the White Tiger"] = true,
		["Blackout Kick"] = true,
		["Touch of Karma"] = true,
		["Fists of Fury"] = true,
	...
	[10] = {
		["SAM_BrewMaster_AoE"] = {
			...
			["MacroVersions"] = {
				{
					"/cast Keg Smash", -- [1]
					"/cast Breath of Fire", -- [2]
					"/cast Blackout Strike", -- [3]
					"/cast Chi Burst", -- [4]
					"/cast Rushing Jade Wind", -- [5]
					"/cast Tiger Palm", -- [6]
					"/cast Blackout Strike", -- [7]
					["PostMacro"] = {
					},
					["KeyPress"] = {
						"/targetenemy [noharm][dead]", -- [1]
		...
		["SAM_WW"] = {
			...
			["MacroVersions"] = {
				{
					"/castsequence reset=combat Tiger Palm, Tiger Palm, Blackout Kick, Blackout Kick, Rising Sun Kick", -- [1]
					"/castsequence reset=combat Tiger Palm, Tiger Palm, Blackout Kick, Blackout Kick, Fists of Fury", -- [2]
					"/cast Tiger Palm", -- [3]
					"/cast Touch of Death", -- [4]
					["KeyRelease"] = {
						"/startattack", -- [1]
						"/cast [combat] Invoke Xuen, the White Tiger", -- [2]
						"/cast [combat] Serenity", -- [3]
						"/cast [combat] Touch of Death", -- [4]
					},
					["KeyPress"] = {
						"/targetenemy [noharm][dead]", -- [1]
					},
			...
			["MacroVersions"] = {
				{
					...
					"/cast Breath of Fire", -- [2]
					"/cast Blackout Strike", -- [3]
					"/cast Rushing Jade Wind", -- [4]
					"/cast Tiger Palm", -- [5]
					"/cast Blackout Strike", -- [6]
					"/cast Blackout Combo", -- [7]
					["PostMacro"] = {
					},
					["KeyPress"] = {
						"/targetenemy [noharm][dead]", -- [1]
		...
		["SAM_winsingle"] = {
			...
			["MacroVersions"] = {
				{
					"/castsequence Tiger Palm, Rising Sun Kick, Tiger Palm, Tiger Palm, Tiger Palm, Tiger Palm", -- [1]
					"/castsequence [nochanneling] Tiger Palm, Fists of Fury, Tiger Palm, Blackout Kick", -- [2]
					"/castsequence [nochanneling] Tiger Palm, Tiger Palm, Tiger Palm, Tiger Palm, Blackout Kick, Fists of Fury, Tiger Palm, Tiger Palm, Tiger Palm, Tiger Palm, Blackout Kick", -- [3]
					"/castsequence Tiger Palm, Rising Sun Kick, Tiger Palm, Tiger Palm, Tiger Palm, Blackout Kick", -- [4]
					["KeyRelease"] = {
						"/startattack", -- [1]
						"/cast [combat] Invoke Xuen, the White Tiger", -- [2]
						"/cast [combat] Serenity", -- [3]
