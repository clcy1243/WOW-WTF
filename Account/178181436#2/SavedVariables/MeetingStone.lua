...
MEETINGSTONE_UI_DB = {
	...
	["global"] = {
		["serverDatas"] = {
			...
			["ActivitiesData"] = {
				["data"] = "$1$Z$S269`魔兽主播活动`恩佐斯的幻象`4月11日（周六）晚8点，快和斗鱼TV人气主播：Sunny蘭兰兰丶（房间号：2987581）共同闯荡觉醒之城*J随着恩佐斯的觉醒，尼奥罗萨，觉醒之城，这座虚空中的宫殿也逐渐浮出水面，艾泽拉斯的勇士们，赶快随着斗鱼TV主播一起，深入这片可怕的领域，与这名上古之神进行最终的对决吧`http://w.163.com/special/convene-stone/`1`3$$",
				["new"] = false,
			},
			["MallData"] = {
