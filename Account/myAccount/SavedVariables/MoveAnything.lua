		...
		["default"] = {
			...
			["frames"] = {
				...
				["ArenaEnemyFrame1CastingBar"] = {
					...
					["name"] = "ArenaEnemyFrame1CastingBar",
					["pos"] = {
						"RIGHT", -- [1]
						"ArenaEnemyFrame1", -- [2]
						"LEFT", -- [3]
				...
				["MainMenuBarArtFrameLeftEndCapMover"] = {
					...
					["name"] = "MainMenuBarArtFrameLeftEndCapMover",
					["pos"] = {
						"BOTTOMLEFT", -- [1]
						"MainMenuBar", -- [2]
						"BOTTOMLEFT", -- [3]
