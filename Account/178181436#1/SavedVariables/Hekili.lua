			...
			["actionLists"] = {
				...
				}, -- [23]
				{
					...
					["Actions"] = {
						...
						{
							["Enabled"] = true,
							["Script"] = "buff.demon_spikes.down&buff.metamorphosis.down",
							["Ability"] = "fiery_brand",
							["CheckMovement"] = false,
							["ModVarName"] = "",
							["Name"] = "Fiery Brand",
						...
						{
							["Enabled"] = true,
							["Script"] = "charges=2||buff.demon_spikes.down&!dot.fiery_brand.ticking&buff.metamorphosis.down",
							["Ability"] = "demon_spikes",
							["CheckMovement"] = false,
							["ModVarName"] = "",
							["Name"] = "Demon Spikes",
						...
						{
							["Enabled"] = true,
							["Script"] = "!sigil_placed&!in_flight&remains-travel_time-delay<0.3*duration&artifact.fiery_demise.enabled&dot.fiery_brand.ticking",
							["Ability"] = "infernal_strike",
							["CheckMovement"] = false,
							["ModVarName"] = "",
							["Name"] = "Infernal Strike",
						...
						{
							["Enabled"] = true,
							["Script"] = "!sigil_placed&!in_flight&remains-travel_time-delay<0.3*duration&(!artifact.fiery_demise.enabled||(max_charges-charges_fractional)*recharge_time<cooldown.fiery_brand.remains+5)&(cooldown.sigil_of_flame.remains>7||charges=2)",
							["Ability"] = "infernal_strike",
							["CheckMovement"] = false,
							["ModVarName"] = "",
							["Name"] = "Infernal Strike (1)",
							["Release"] = 201617.031,
							["Indicator"] = "none",
							["ModName"] = "",
						}, -- [5]
						...
						{
							["Enabled"] = true,
							["Script"] = "dot.fiery_brand.ticking",
							["Ability"] = "soul_carver",
							["CheckMovement"] = false,
							["ModVarName"] = "",
							["Name"] = "Soul Carver",
						...
						{
							["Enabled"] = true,
							["Script"] = "toggle.cooldowns&(buff.demon_spikes.down&!dot.fiery_brand.ticking&buff.metamorphosis.down&incoming_damage_5s>health.max*0.70)",
							["Ability"] = "metamorphosis",
							["CheckMovement"] = false,
							["ModVarName"] = "",
							["Name"] = "Metamorphosis",
						...
						{
							["Enabled"] = true,
							["Script"] = "incoming_damage_5s>health.max*0.70",
							["Ability"] = "fel_devastation",
							["CheckMovement"] = false,
							["ModVarName"] = "",
							["Name"] = "Fel Devastation",
						...
						{
							["Enabled"] = true,
							["Script"] = "remains-delay<=0.3*duration",
							["Ability"] = "sigil_of_flame",
							["CheckMovement"] = false,
							["ModVarName"] = "",
							["Name"] = "Sigil of Flame",
						...
						{
							["Enabled"] = true,
							["Script"] = "pain.current>=80&soul_fragments<4&incoming_damage_4s<=health.max*0.20",
							["Ability"] = "fracture",
							["CheckMovement"] = false,
							["ModVarName"] = "",
							["Name"] = "Fracture",
